...
public class StockLogic {
    ...
    public TickerDataModel getTickerData(String ticker) {
        try {
            ...
            Elements tickerElement =
                    tickerDoc.select("div#industry span.PriceBoardMain__code__2wso");
            Elements sectorElement =
                    tickerDoc.select("div#industry a.PriceBoardMain__industryName__1uny");
            Elements priceElement = tickerDoc
                    .select("div.PriceBoardMain__headerPrice__gbs7 span.StyledNumber__value__3rXW");
            Elements transactionElement =
                    tickerDoc.select("span.StyledNumber__value__3rXW.DataListItem__value__11kV");
