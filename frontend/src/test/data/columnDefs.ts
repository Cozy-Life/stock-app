    ...
    children: [
      {
        ...
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#cfa" },
      },
      {
        field: "bank_2",
        headerName: "楽天銀行",
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#fba" },
      },
      {
        field: "stock_1",
        headerName: "楽天証券",
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#fac" },
      },
    ...
    children: [
      {
        ...
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#afb" },
      },
      {
        field: "bank_4",
        headerName: "ゆうちょ",
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#afe" },
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#acf" },
      },
      {
        field: "pension_3",
        headerName: "変額保険",
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#ffa" },
      },
      {
        field: "pension_4",
        headerName: "個人年金",
        sortable: true,
        filter: true,
        headerStyle: { backgroundColor: "#eaf" },
      },
